  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFFFDFDFE), // iOS gray6
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment:
                      MainAxisAlignment.spaceBetween, // rating tetap kanan
                  children: [
                    // time + serving jadi satu grup
                    Row(
                      children: [
                        _infoItem(HugeIcons.strokeRoundedClock01, time),
                        const SizedBox(
                          width: 6,
                        ), // jarak time & serving lebih rapat
                        _infoItem(HugeIcons.strokeRoundedRiceBowl01, serving),
                      ],
                    ),
                    _ratingStars(rating), // rating tetap di kanan
                  ],
                ),
              ],
            ),
